...
import { findUserByEmail, createUser, deleteUser } from '@/lib/supabase-db'
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Received signup data (alt route):', body)
    ...
    console.error('Creator signup error (alt route):', error)
