...
export function UnderConstruction() {
  return (
    <div className="min-h-screen bg-background-light font-display text-text-primary flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10 max-w-4xl">
        ...
        {/* Main heading */}
        <h1 className="text-5xl md:text-7xl font-black text-text-primary leading-tight tracking-tighter mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 shadow-lg transform hover:-translate-y-2 transition-transform">
        ...
        <div className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl p-8 border border-primary/20 backdrop-blur-sm">
